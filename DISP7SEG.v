...
assign seg = text_mode & error ? ( sel == 3'b000 ? 8'b11111111 : sel == 3'b001 ? 8'b00101111 : sel == 3'b010 ? 8'b10101111 : sel == 3'b011 ? 8'b10000110: 8'b11111111):
	         text_mode & fast  ? ( sel == 3'b000 ? 8'b10000111 : sel == 3'b001 ? 8'b10010010 : sel == 3'b010 ? 8'b10001000 : sel == 3'b011 ? 8'b10001110: 8'b11111111):
             text_mode & med   ? ( sel == 3'b000 ? 8'b10100001 : sel == 3'b001 ? 8'b10100011 : sel == 3'b010 ? 8'b10100011 : sel == 3'b011 ? 8'b10010000: 8'b11111111):
             text_mode & slow  ? ( sel == 3'b000 ? 8'b11111111 : sel == 3'b001 ? 8'b01000000 : sel == 3'b010 ? 8'b11000111 : sel == 3'b011 ? 8'b10010010: 8'b11111111):
             seg_number;
